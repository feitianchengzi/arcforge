...
- sharing-ipc/solution.md 依赖 workspace/solution.md 的扫描结果、profiles-sync/solution.md 的漂移结果模型和 architecture/solution.md 的 IPC 边界。
- cli/solution.md 直接复用 workspace/solution.md、audit/solution.md、profiles-sync/solution.md 和 sharing-ipc/solution.md 中的 core 能力。
...
- publish-plan 只读取工作区并生成计划；publish-share 执行 Git 写入和推送。
- source-download 返回本地项目根路径，随后由 workspace-scan 打开。
- system-environment 独立于工作区，用于桌面端环境提示。
