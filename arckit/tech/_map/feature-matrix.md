...
| profiles-sync/solution.md | 🔬 调研中 | 来源推荐、未分类门禁、Agent 项目评估、三类计划、扁平 catalog 身份、SemVer 决议、显式来源选择、整理和漂移 | SkillProjectManifest、SkillProjectApplicabilityAssessment、CatalogSourceSelection、ArcForgeConfig、SkillAvailabilityPlan、CatalogVersionDecision、UserSkillCatalog、AppliedSourceRecord、ApplyProfileResult、DriftReport | apply-plan、apply-run、apply-drift、catalog-resolve |
