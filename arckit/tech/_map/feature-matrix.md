...
| sharing-ipc/solution.md | ✅ 已采用 | preload 桥接、来源下载、发布计划、共享推送、环境检测 | PublishPlan、ShareResult、EnvironmentStatus | source-download、publish-plan、publish-share、system-environment |
| cli/solution.md | ✅ 已采用 | init、scan、audit、publish-plan、drift、apply-profile JSON 命令 | SkillOpsConfig、WorkspaceSnapshot、AuditReport、PublishPlan、DriftReport、ApplyProfileResult | 与 IPC 同构但不经 Electron |
