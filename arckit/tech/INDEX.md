...
- sharing-ipc/ 共享与 IPC 技术：Electron preload 桥、应用数据目录注入、技能文件编辑、权限预检、共享漂移、共享工作树和 Git/PR 执行。✅
  - solution.md 共享与 IPC 方案：安全桥接、来源下载、发布计划、共享漂移、共享推送、CLI 修复、技能文件编辑和差异窗口。✅ (167行)
