...
- themes/ 主题配置：亮色主主题与未来深色主题覆盖值。🟡
  ...
  - dark.yaml 深色主题：未来暗色主题 token 覆盖方向。⚪ (21行)
- _map/ 映射：视觉源、投影、跨域关系和状态矩阵。✅
  - RELATIONS.md 视觉关系：brief、tokens、组件、主题、预览与其他 ArcKit 域的关系。✅ (16行)
  - feature-matrix.md 视觉功能矩阵：视觉文件状态、用途和来源依据。✅ (11行)
