...
| interface/agent-skill.md | ⚪ 计划中 | 在项目目录中通过 SkillOps skill 把项目内 skill 归并为正式来源、同步到其他项目并共享到远程仓库 | 用户产品方向讨论、skills/skillops/SKILL.md、interface/cli.md、interface/desktop-app.md |
