...
- workspace/discovery.md 产生工作区快照和本地 Git 信息，供 audit/rule-audit.md、profile/destination-sync.md、sources/skill-project-merge.md、share/github-sharing.md、interface/desktop-app.md 和 interface/cli.md 使用。
...
- interface/cli.md 直接调用核心模块中的 workspace、audit、profile、publish-plan、source update、share、归并和应用关系能力。
