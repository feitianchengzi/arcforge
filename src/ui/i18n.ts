...
export const dictionaries: Record<Language, Dictionary> = {
  en: {
    ...
    githubProjectHelp: "Download a Skill project or single skill folder into the local ArcForge cache.",
    ...
    desktopRequired: "Project actions require the Electron desktop window. Please use the ArcForge app window, not the browser tab.",
    ...
    cliRepairAvailable: "CLI repaired. Open a new terminal if an old terminal still cannot find arcforge.",
    ...
    cliRepairManualBody: "ArcForge could not fully verify the CLI in the current environment. Copy these details to a terminal or another repair tool.",
    ...
    emptyBody: "ArcForge can open a repository with a skills/ directory, or a single skill folder that contains SKILL.md.",
    ...
    shareNamedProjectHelp: "ArcForge writes this project into a named folder under the repository path.",
  ...
  "zh-CN": {
    ...
    githubProjectHelp: "把 Skill 项目或单个 skill 文件夹下载到本地 ArcForge 缓存。",
    ...
    cliRepairAvailable: "CLI 已修复。如果旧终端仍找不到 arcforge，请打开一个新终端。",
    ...
    emptyBody: "ArcForge 可以打开包含 skills/ 目录的仓库，也可以直接打开包含 SKILL.md 的单个 skill 文件夹。",
    emptyExample: "示例：\nskills/\n  code-review/\n    SKILL.md\n\n单个 skill 文件夹：\ncode-review/\n  SKILL.md",
    metrics: {
      skills: "技能数",
      auditScore: "审计评分",
    ...
    shareNamedProjectHelp: "ArcForge 会把当前项目写入仓库路径下的项目名称目录。",
